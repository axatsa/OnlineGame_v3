...
- [x] Toggle в хедере работает
- [x] Тема сохраняется после перезагрузки страницы
- [x] Все основные страницы выглядят корректно в тёмной теме (переменные заложены)
- [x] Нет визуальных дефектов (белые острова, невидимый текст)
